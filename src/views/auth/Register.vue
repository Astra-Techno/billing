...
<template>
  <div class="auth-page min-h-screen min-h-[100dvh] flex flex-col md:flex-row w-full">

    <!-- Left: Brand panel — desktop only -->
    <div class="hidden md:flex md:w-5/12 bg-primary-600 via-primary-700 to-blue-800 flex-col items-center justify-center px-10 py-8 md:h-full overflow-y-auto">
    ...
    <!-- Right: Form panel -->
    <div class="auth-form-panel flex-1 flex flex-col min-h-0 bg-white md:items-center md:justify-center">
      <div class="flex-1 overflow-y-auto overscroll-contain px-4 pt-6 pb-4 md:py-8 md:overflow-visible">
      <div class="w-full max-w-sm mx-auto">

        <!-- Step 1 -->
        <form v-if="step === 1" id="register-step1" @submit.prevent="nextStep" class="space-y-3">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.name" type="text" class="form-input pl-10" placeholder="Rajesh Kumar" required dir="ltr" autocomplete="name" />
            </div>
          </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.email" type="email" class="form-input pl-10" placeholder="rajesh@example.com" required dir="ltr" autocomplete="email" />
            </div>
          </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.mobile" type="tel" class="form-input pl-10" placeholder="9876543210" maxlength="10" required dir="ltr" autocomplete="tel" inputmode="tel" />
            </div>
          </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.password" :type="showPass ? 'text' : 'password'" class="form-input pl-10 pr-10" placeholder="Min 8 characters" required dir="ltr" autocomplete="new-password" />
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.password_confirmation" :type="showConfirm ? 'text' : 'password'" class="form-input pl-10 pr-10" placeholder="Repeat password" required dir="ltr" autocomplete="new-password" />
          ...
          <button type="submit" class="hidden md:flex w-full items-center justify-center gap-2 py-3 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white font-semibold text-sm shadow-md shadow-primary-200">
            Continue
        ...
        <!-- Step 2 -->
        <form v-else id="register-step2" @submit.prevent="submit" class="space-y-3">
          <div class="mb-4">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.business_name" type="text" class="form-input pl-10" placeholder="e.g. Sharma Electronics" required dir="ltr" />
            </div>
          </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.gstin" type="text" class="form-input pl-10" placeholder="e.g. 29AABCU9603R1Z6" maxlength="15" dir="ltr" />
            </div>
          </div>
          ...
          <button type="submit"
            class="hidden md:flex w-full items-center justify-center gap-2 py-3 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white font-semibold text-sm shadow-md shadow-primary-200"
            :disabled="loading">
        ...
        <p class="text-sm text-center text-gray-400 mt-4 hidden md:block">
      ...
      <div class="auth-sticky-footer md:hidden shrink-0 px-4 pt-2 pb-[max(1rem,env(safe-area-inset-bottom))] bg-white border-t border-gray-100">
        <button v-if="step === 1" type="submit" form="register-step1"
          class="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl bg-primary-600 text-white font-semibold text-base shadow-lg">
          Continue
        ...
        <p class="text-sm text-center text-gray-400 mt-3">
          Already have an account?
          <RouterLink to="/login" class="text-primary-600 font-semibold">Sign in</RouterLink>
        </p>
      </div>
    </div>
