...
const allNavRaw = [
  ...
  { name: 'Payroll',         to: '/payroll',           perm: 'payroll',          icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', tint: 'from-green-500 to-emerald-600' },
  { name: 'GST Filing',      to: '/gst-returns',       perm: 'gst',              icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', tint: 'from-emerald-500 to-teal-600' },
    ...
    <div class="px-4 pt-5 lg:w-80 shrink-0">
      ...
      <div class="mt-4 lg:mt-0 card-premium p-5 relative overflow-hidden">
        ...
        <div class="flex gap-2 mt-5 relative">
          <RouterLink v-if="can('settings')" to="/settings" class="btn-primary btn-sm flex-1 text-center">Settings</RouterLink>
