...
<head>
<meta charset="utf-8">
<title>AI Billing — Help Guide</title>
<style>
...
<body>
<h1>AI Billing — Complete Help Guide</h1>
<p class="meta">Generated on ${d} &nbsp;|&nbsp; aibilling.in</p>
...
<div class="tip"><strong>Filing happens on the GST portal.</strong> AI Billing prepares your summary — you log in to gst.gov.in to submit the actual return.</div>
</section>
...
<section>
<h2>AI Billing vs Vyapar</h2>
<table>
  <thead>
    <tr><th>Feature</th><th>AI Billing</th><th>Vyapar</th></tr>
  </thead>
  <tbody>
...
<p class="footer">AI Billing &nbsp;·&nbsp; Complete Help Guide &nbsp;·&nbsp; Generated ${d}</p>
      ...
      <div class="flex-1 space-y-8">
          ...
          <div class="relative z-10">
            ...
            <div class="space-y-6 text-sm text-gray-700">
              <div class="bg-gradient-to-r from-blue-50 to-primary-50 border border-blue-100/50 rounded-2xl p-5 shadow-sm">
                <p class="font-bold text-blue-900 mb-1.5 text-base">Welcome to AI Billing! 🎉</p>
          ...
          <div class="relative z-10">
            ...
            <div class="space-y-6 text-sm text-gray-700">
              ...
              <div class="bg-emerald-50 border border-emerald-100 rounded-xl p-4 shadow-sm">
                ...
                <p class="text-sm text-emerald-800 leading-relaxed">Tap <strong>Record Payment</strong> on any sent invoice to log cash, UPI, NEFT, or cheque receipts. You can record multiple payments over time — AI Billing automatically tracks the running balance due and marks the invoice as Paid when fully settled.</p>
              </div>
              ...
              <div class="bg-green-50 border border-green-100 rounded-xl p-4 flex gap-3 shadow-sm">
                ...
                <p class="text-sm text-green-800 leading-relaxed"><strong>Auto GST split:</strong> Same state → CGST + SGST. Different state → IGST. Bill of Supply → no GST. AI Billing handles all cases automatically based on your bill type and customer's state.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div class="space-y-5 text-sm text-gray-700">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="bg-white border border-gray-100 shadow-sm rounded-2xl p-4">
                  ...
                  <p class="text-gray-500">Setting the correct state on a customer record ensures AI Billing applies CGST+SGST or IGST automatically on every invoice.</p>
                </div>
              </div>
        ...
        <section :id="'gst'" class="card p-8 scroll-mt-6 border-0 shadow-soft relative overflow-hidden group">
          ...
          <div class="relative z-10">
            ...
            <div class="space-y-5 text-sm text-gray-700">
              <p class="text-gray-500 leading-relaxed">AI Billing auto-compiles your GST return data from invoices, credit notes, and expenses. Use this section to review totals before filing on the GST portal.</p>
              ...
              <div class="bg-yellow-50 border border-yellow-100 rounded-xl p-4 flex gap-3 shadow-sm">
                ...
                <p class="text-sm text-yellow-900 leading-relaxed"><strong>Filing happens on the GST portal.</strong> AI Billing prepares and displays your summary — you then log in to <strong>gst.gov.in</strong> to submit the actual return. Always review totals carefully before filing.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section :id="'vs-vyapar'" class="card p-8 scroll-mt-6 border-0 shadow-soft relative overflow-hidden group">
          ...
          <div class="relative z-10">
            <div class="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 class="text-xl font-extrabold text-gray-900">AI Billing vs Vyapar</h2>
            ...
            <div class="space-y-7 text-sm text-gray-700">
              ...
              <div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-5 text-white">
                ...
                <p class="text-primary-100 text-sm leading-relaxed">Vyapar is a solid app with many features. AI Billing is for businesses that want a fast, modern billing experience without a yearly subscription or cluttered screens.</p>
              </div>
                ...
                <table class="w-full text-sm border-collapse">
                  <thead>
                    <tr class="bg-gray-800 text-white">
                      ...
                      <th class="px-4 py-3 text-center font-semibold text-primary-200">AI Billing</th>
          ...
          <div class="space-y-3">
            <details class="group bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden" open>
              <summary class="flex items-center justify-between p-5 cursor-pointer font-bold text-gray-900 select-none hover:bg-gray-50 transition-colors">
                Can I use AI Billing without a GSTIN?
        ...
        <div class="mt-12 text-center pb-8 opacity-70">
          ...
          <p class="text-sm font-bold text-gray-800">AI Billing</p>
